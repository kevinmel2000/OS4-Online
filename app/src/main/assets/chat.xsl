...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  xmlns:t="jabber:client">
    ...
    <xsl:template match="messages">
        ...
        <!--h4>Contacts</h4-->
        <ul data-role="listview" data-filter="true" data-input="#myFilter" data-autodividers="true" style="margin: 0 10px;">
            ...
            <xsl:choose>
                ...
                <li class="self">
                    <div class="messages">
                        ...
                        <p><xsl:value-of select="t:body/text()"/></p>
                ...
                <li class="other">
                    <div class="messages">
                        <a href="#" class="hb-thumbnail floatleft"><img src="images/48.png" style="width:48px;hight:48px;border-radius: 100%;"/></a>
                        <span class="title"><a href="profil.html"><xsl:value-of select="@to"/></a></span>
                        <p><xsl:value-of select="t:body/text()"/></p>
                        <time datetime="2009-11-13T20:00"><xsl:value-of select="@from"/></time>
                    </div>
                </li>
