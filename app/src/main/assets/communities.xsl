...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:jabber="jabber:client" xmlns:ecb="http://jabber.org/protocol/disco#items">
    <xsl:output encoding="utf-8" indent="no"/>
    <xsl:template match="jabber:iq">
        <html>
        <head>
            ...
            <xsl:for-each select="ecb:item">
                ...
                <li class="self">
                    <div class="messages">
                        ...
                        <time datetime="2009-11-13T20:00"><xsl:value-of select="@member"/></time>
                    </div>
                </li>
                </xsl:when>
                <xsl:otherwise>
